...
namespace Metier.Migrations
{
    ...
    [Migration("20190705075316_SecondUpdateUtilisateur")]
    partial class SecondUpdateUtilisateur
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Metier.Entities.Action", b =>
                {
                    ...
                    b.Property<int?>("codePerimetreRecrutementId");

                    b.Property<string>("codePublicVise");

                    b.Property<string>("conditionsSpecifiques");

                    b.Property<int?>("conventionnementId");
                    ...
                    b.Property<int?>("modaliteEnseignementId");

                    b.Property<int?>("modaliteEntreesSortiesId");
                    ...
                    b.Property<int?>("niveauEntreeObligatoireId");
                    ...
                    b.Property<int?>("priseEnChargeFraisPossibleId");
                    ...
                    b.HasIndex("codePerimetreRecrutementId");

                    b.HasIndex("conventionnementId");

                    b.HasIndex("lieuFormationId");

                    b.HasIndex("modaliteEnseignementId");

                    b.HasIndex("modaliteEntreesSortiesId");

                    b.HasIndex("niveauEntreeObligatoireId");

                    b.HasIndex("organismeFinanceurId");

                    b.HasIndex("organismeFormateurId");

                    b.HasIndex("priseEnChargeFraisPossibleId");
            ...
            modelBuilder.Entity("Metier.Entities.Formation", b =>
                {
                    ...
                    b.Property<int?>("codeNiveauEntreeId");

                    b.Property<int?>("codeNiveauSortieId");
                    ...
                    b.Property<int?>("objectifGeneralFormationId");

                    b.Property<int?>("organismeFormationResponsableId");

                    b.Property<int?>("parcoursDeFormationId");

                    b.Property<int?>("positionnementId");
                    ...
                    b.HasIndex("codeNiveauEntreeId");

                    b.HasIndex("codeNiveauSortieId");
                    ...
                    b.HasIndex("objectifGeneralFormationId");

                    b.HasIndex("organismeFormationResponsableId");

                    b.HasIndex("parcoursDeFormationId");

                    b.HasIndex("positionnementId");
            ...
            modelBuilder.Entity("Metier.Entities.OrganismeFinanceur", b =>
                {
                    ...
                    b.Property<int?>("codeFinanceurId");

                    b.Property<int>("nbPlaceFinancees");

                    b.HasKey("Id");

                    b.HasIndex("codeFinanceurId");
            ...
            modelBuilder.Entity("Metier.Entities.Session", b =>
                {
                    ...
                    b.Property<int?>("etatRecrutementId");
            ...
            modelBuilder.Entity("Metier.Entities.Action", b =>
                {
                    ...
                    b.HasOne("Metier.Entities.Code", "codePerimetreRecrutement")
                        .WithMany()
                        .HasForeignKey("codePerimetreRecrutementId");

                    b.HasOne("Metier.Entities.Code", "conventionnement")
                        .WithMany()
                        .HasForeignKey("conventionnementId");

                    b.HasOne("Metier.Entities.Coordonnees", "lieuFormation")
                        .WithMany()
                        .HasForeignKey("lieuFormationId");

                    b.HasOne("Metier.Entities.Code", "modaliteEnseignement")
                        .WithMany()
                        .HasForeignKey("modaliteEnseignementId");

                    b.HasOne("Metier.Entities.Code", "modaliteEntreesSorties")
                        .WithMany()
                        .HasForeignKey("modaliteEntreesSortiesId");

                    b.HasOne("Metier.Entities.Code", "niveauEntreeObligatoire")
                        .WithMany()
                        .HasForeignKey("niveauEntreeObligatoireId");
                    ...
                    b.HasOne("Metier.Entities.Code", "priseEnChargeFraisPossible")
                        .WithMany()
                        .HasForeignKey("priseEnChargeFraisPossibleId");
            ...
            modelBuilder.Entity("Metier.Entities.Formation", b =>
                {
                    ...
                    b.HasOne("Metier.Entities.Code", "codeNiveauEntree")
                        .WithMany()
                        .HasForeignKey("codeNiveauEntreeId");

                    b.HasOne("Metier.Entities.Code", "codeNiveauSortie")
                        .WithMany()
                        .HasForeignKey("codeNiveauSortieId");
                    ...
                    b.HasOne("Metier.Entities.Code", "objectifGeneralFormation")
                        .WithMany()
                        .HasForeignKey("objectifGeneralFormationId");
                    ...
                    b.HasOne("Metier.Entities.Code", "parcoursDeFormation")
                        .WithMany()
                        .HasForeignKey("parcoursDeFormationId");

                    b.HasOne("Metier.Entities.Code", "positionnement")
                        .WithMany()
                        .HasForeignKey("positionnementId");
            ...
            modelBuilder.Entity("Metier.Entities.OrganismeFinanceur", b =>
                {
                    b.HasOne("Metier.Entities.Code", "codeFinanceur")
                        .WithMany()
                        .HasForeignKey("codeFinanceurId");
                });
            ...
            modelBuilder.Entity("Metier.Entities.Session", b =>
                {
                    ...
                    b.HasOne("Metier.Entities.Code", "etatRecrutement")
                        .WithMany()
                        .HasForeignKey("etatRecrutementId");
